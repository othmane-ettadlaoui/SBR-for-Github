...
Ce qui preuve que :
$$
R_n = \sqrt[n]{\frac{1+t_n}{1-t_n * \sum_{i=1}^{n} \frac{1}{(1+R_i)^{i}}}} - 1
$$
...
D’abord Commençons par la définition des différents risques dans les secteurs d’assurance et de réassurance :
...
## (ANNEXE N°12) CORRESPONDANCE ENTRE ECHELLE DE NOTATION ET PROBABILITE DE DEFAUT:
